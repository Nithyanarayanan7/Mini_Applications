...
public class Railway {
    private static final String train_name = "Intercity";
    private static final String train_num = "CSE106";
    ...
    private static void admin() {
        ...
        if (admin_id == 001 && admin_pass == 1234) {
    ...
    private static void cancel_ticket() {
        ...
        System.out.printf("%-20s || %-20s || %-20s || %-20s || \n", "User _Id", "Departure Station", "Aravial Station",
                "Ticket Number");
